  ...
  it('shows logs when prerendering', async () => {
    expect(logs).toMatchInlineSnapshot(`
      [
        ...
        "█ 4 <link rel="preload" as="fetch" crossorigin="anonymous" href="/_payload.json?_b=test">",
